...
<form action="/program" method="POST" style="margin:16px">
  <label for="cars">Choose a program:</label>
  <select name="programSelect" id="programSelect">

     <c:forEach var="program" items="${programs}">
             <option value=${program.programName} name="selectedOption">${program.programName}</option>
        </c:forEach>
  </select>
  <br><br>
